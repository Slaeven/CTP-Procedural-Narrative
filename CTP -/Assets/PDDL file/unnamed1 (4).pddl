(define (domain magic-world)
   ...
   (:action gather-wood
      ...
      :precondition (and (at ?p ?l) (at ?n ?l) (wood ?e) (at ?e ?l))
      :effect (and (has-wood ?p) not (has-wood ?l))
   )
   (:action gather-ore
      :parameters (?p - player ?n - person ?l - location ?e - element)
      :precondition (and (at ?p ?l) (at ?n ?l) (ore ?e) (at ?e ?l))
      :effect (and (has-ore ?p) not (has-ore ?l))
   )
   (:action gather-water
      :parameters (?p - player ?n - person ?l - location ?e - element)
      :precondition (and (at ?p ?l) (at ?n ?l) (water ?e) (at ?e ?l))
      :effect (and (has-water ?p) not (has-water ?l))
   )
   (:action gather-fish
      :parameters (?p - player ?n - person ?l - location ?e - element)
      :precondition (and (at ?p ?l) (at ?n ?l) (fish ?e) (at ?e ?l))
      :effect (and (has-fish ?p) not (has-fish ?l))
   )
   (:action give-wood
      :parameters (?p - player ?n - person ?l - location ?e - element)
      :precondition (and (at ?p ?l) (at ?n ?l) (wood ?e) (has-wood ?p))
      :effect (and (has-wood ?p) not (has-wood ?n))
   )
   (:action give-wood
      :parameters (?p - player ?n - person ?l - location ?e - element)
      :precondition (and (at ?p ?l) (at ?n ?l) (wood ?e) (has-wood ?p))
